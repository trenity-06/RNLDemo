    ...
    return (
        <>
            <div className="min-h-screen flex flex-row bg-white">                
                ...
                <div className='hidden lg:flex w-1/2 h-screen items-center justify-center bg-white relative overflow-hidden'>                    <div className="absolute inset-0 bg-linear-to-t from-white/20 to-transparent"></div>
